...
`01:53` can say, you know, tell me a software stack for Visual Lore, which is a
`01:55` stack for Visual Lore, which is a
`01:55` stack for Visual Lore, which is a software that I was working on for
`01:56` software that I was working on for
`01:56` software that I was working on for another company, and it's able to go and
`01:59` another company, and it's able to go and
`01:59` another company, and it's able to go and look through our older conversations,
`02:00` look through our older conversations,
`02:00` look through our older conversations, which is nice. That's a little bit of
`02:02` which is nice. That's a little bit of
`02:02` which is nice. That's a little bit of extra there, but it's still not, you
`02:03` extra there, but it's still not, you
`02:03` extra there, but it's still not, you know, it's not able to look at files,
`02:05` know, it's not able to look at files,
`02:05` know, it's not able to look at files, have persistence, things like that. And
`02:08` have persistence, things like that. And
`02:08` have persistence, things like that. And you're constantly having to make these
`02:09` you're constantly having to make these
`02:09` you're constantly having to make these huge prompts. Maybe you have some sort
...
`03:17` token from linguistics, which borrowed it from Old English tucken, which means
`03:19` it from Old English tucken, which means
`03:19` it from Old English tucken, which means a sign or a symbol. A token is just the
`03:22` a sign or a symbol. A token is just the
`03:22` a sign or a symbol. A token is just the smallest meaningful chunk of a sentence
...
`05:24` else remembers when they were just called that for headers. Um, you have
`05:27` called that for headers. Um, you have
`05:27` called that for headers. Um, you have all sorts of stuff like asterisks for
`05:29` all sorts of stuff like asterisks for
`05:29` all sorts of stuff like asterisks for bolding or doing things in that way. And
`05:31` bolding or doing things in that way. And
`05:31` bolding or doing things in that way. And there's a lot of programs that can
`05:32` there's a lot of programs that can
`05:32` there's a lot of programs that can actually run this to look a certain way.
...
`06:45` reason for each one. If you look at my Claude.md,
`06:47` Claude.md,
`06:47` Claude.md, my Claude markdown file, this is
...
`07:07` actually just type in to Claude read the Claude.md. In this case, it's Claude
`07:09` Claude.md. In this case, it's Claude
`07:09` Claude.md. In this case, it's Claude code. You could be working inside of
...
`07:21` the VS code is too much for you. Um but just read the Claude.md and tell me what
`07:23` just read the Claude.md and tell me what
`07:23` just read the Claude.md and tell me what this is. Before you had to copy and
...
`07:29` read the every file that's in here. In this case, it reads the Claude.md and
`07:32` this case, it reads the Claude.md and
`07:32` this case, it reads the Claude.md and immediately, without having to read
...
`09:18` just you can just edit it without any of this. Look, my uh my claude.md, this is
`09:21` this. Look, my uh my claude.md, this is
`09:21` this. Look, my uh my claude.md, this is what it looks like in if you open up
...
`10:24` terrible prompting. Yet, the agent, without wasting a whole bunch of co-kens
`10:26` without wasting a whole bunch of co-kens
`10:26` without wasting a whole bunch of co-kens and going through everything,
`10:27` and going through everything,
`10:27` and going through everything, immediately goes to the context file
...
`15:24` this idea that you can download them from everywhere. There's PowerPoint
...
`16:14` MCP servers. If you don't know what an MCP, model context protocol. I think
`16:17` MCP, model context protocol. I think
`16:17` MCP, model context protocol. I think that deserves an entire video in itself,
`16:19` that deserves an entire video in itself,
`16:19` that deserves an entire video in itself, but just think of it as a way that the
`16:21` but just think of it as a way that the
`16:21` but just think of it as a way that the AI can talk to other apps and services
`16:24` AI can talk to other apps and services
`16:24` AI can talk to other apps and services easier. It's designed to just kind of
`16:26` easier. It's designed to just kind of
`16:26` easier. It's designed to just kind of plug and play it in, rather than you
`16:28` plug and play it in, rather than you
`16:28` plug and play it in, rather than you have to create all these custom
`16:29` have to create all these custom
`16:29` have to create all these custom integrations. At certain points, we
...
`21:26` paper right now that goes into the history of programming's rules of
`21:27` history of programming's rules of
`21:27` history of programming's rules of transparency, rules of composition,
...
`22:04` because some of this is kind of technical information. nerdy. I'm being
`22:06` technical information. nerdy. I'm being
`22:06` technical information. nerdy. I'm being structured in it. But, this is layering
`22:08` structured in it. But, this is layering
`22:08` structured in it. But, this is layering out what the next decade is looking
`22:11` out what the next decade is looking
`22:11` out what the next decade is looking like. And this isn't because I'm
`22:12` like. And this isn't because I'm
`22:12` like. And this isn't because I'm predicting the future, it's because I'm
