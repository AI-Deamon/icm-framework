...
The real history of AI, from programmable robots in ancient Alexandria to the language models on your phone. Two thousand years of thinking machines that most people have never heard of, and the pattern that connects all of them.

# 📝 Why This Lesson Is Here

*Before you watch the videos in this course, you need to see the pattern.*

Every generation has built thinking machines. Every generation believed they had either achieved the impossible or hit the absolute limit of what machines could do. Every generation was wrong.

Heron of Alexandria programmed a robot theatre with ropes and knots in 62 CE. Al-Jazari built reprogrammable automata in 1206.

Jacquard's loom stored programs on punched cards in 1801. Babbage designed a general-purpose computer from brass and steel. Lovelace wrote the first algorithm. Turing asked what happens if we teach machines to learn.

Each layer seemed impossible until it existed. Then we normalized it, forgot the complexity underneath, and declared the next layer impossible.

AI is the latest layer. It will not be the last.

This article walks through the full history.

It matters because the videos in Module 2 of this course were recorded in 2023 and 2024, when most people thought AI was brand new.

They were already building on two thousand years of the same pattern. Understanding that pattern changes how you hear everything that comes after.
...
In the future, we’ll have **to explain** [**Google.com**](http://Google.com "http://Google.com") **to our kids.**
...
![Generated image](https://substackcdn.com/image/fetch/$s_!X48M!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fa02eb3bd-8ee6-4399-b618-51cbad144872_1536x1024.png "Generated image")
...
![](https://substackcdn.com/image/fetch/$s_!p7IS!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F9b71ee04-f6f5-4c1e-aa70-c6eb74096348_1536x1024.png "null")

## **The First Programmers Used Sticks and Stones…**

In Alexandria, around 62 CE—*we know the date because Heron references a lunar eclipse visible from Alexandria on March 13 of that year*—an inventor built what we’d now recognize [as the world’s first programmable robot](https://link.springer.com/chapter/10.1057/9781137319678_2 "https://link.springer.com/chapter/10.1057/9781137319678_2").
...
![](https://substackcdn.com/image/fetch/$s_!19jd!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F19867480-30ab-4b86-a5db-db4ae91ec5ea_1536x1024.png "null")
...
## **The Memory Machines of Baghdad**
...
![](https://substackcdn.com/image/fetch/$s_!h8b6!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F74604dac-0828-41e3-a0ea-28bd5b7f7176_1024x1536.png "null")
...
## **The Philosophers and the Frauds**
...
![](https://substackcdn.com/image/fetch/$s_!g6dP!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F1bb66c9b-ca6e-4180-bc97-09494b00274b_1536x1024.png "null")
...
[Recent papers show our best language models](https://arxiv.org/abs/2503.23674 "https://arxiv.org/abs/2503.23674") have fooled humans consistently enough to make us believe we’re conversing with another person. The words are arranged appositely, the replies are contextual, the conversation flows naturally.
...
Unfortunately, this particular part of the conversation is out of the scope of this article however I explore what it “means to think” a but deeper [here in this article](https://jakevanclief.substack.com/p/calculating-consciousness "https://jakevanclief.substack.com/p/calculating-consciousness") if you want to continue reading.
...
![](https://substackcdn.com/image/fetch/$s_!8NmR!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F4f27bf9c-3832-4381-b221-5de9285fd7b9_1024x1536.png "null")

#### ***Charles Babbage* saw these looms and recognized something profound.**
...
*Note G* contained what everyone agrees was the first computer algorithm, a method for calculating [Bernoulli numbers](https://mathworld.wolfram.com/BernoulliNumber.html "https://mathworld.wolfram.com/BernoulliNumber.html") that demonstrated loops, conditional branching, and storage of intermediate results.
...
## **The Stubborn Persistence of Low-Level Reality**
...
[Modern branch predictors](https://en.wikipedia.org/wiki/Branch_predictor "https://en.wikipedia.org/wiki/Branch_predictor") achieve 95% accuracy on typical applications, using neural networks—yes, the AMD Ryzen processor in your computer uses perceptron-based neural branch prediction—to anticipate which code will run.
...
![undefined](https://substackcdn.com/image/fetch/$s_!wTqe!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F8f4bdcca-9984-4faa-97fb-1e273a6b4431_1024x981.png "undefined")
...
![](https://substackcdn.com/image/fetch/$s_!G0Ft!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fba237783-8dc1-4684-9c5d-82f4722abab9_1024x1536.png "null")
...
## **The Machines That Taught Themselves**
...
![Generated image](https://substackcdn.com/image/fetch/$s_!w0yS!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fd6d0b397-ce5c-47df-a74d-060ebc0a46b8_1024x1536.png "Generated image")
...
Just the rules and play against yourself. **It mastered chess in four hours.** Not four years or four months—f**our hours to surpass Stockfish,** the world’s strongest traditional engine. **Two hours to dominate shogi.** Thirty hours **to exceed the original AlphaGo at Go.**
...
## **The Compiler for Human Thought**
...
[AI is the next compiler in this stack.](https://www.youtube.com/watch?v=RZ0AcCLVPFA&t=238s "https://www.youtube.com/watch?v=RZ0AcCLVPFA&t=238s")
