# ADVANCED: Coding Best Practices - Davids Corner
...
> This is what I use personally. This was made by giving claude 20ish years of my code. its designed to make sure claude writes and organizes code in exactly the way i write and organize code. this makes sure it fits my mental model. one thing i did add was inline documentation and header status/tasks/todos/notes. this along with being very intentional about my naming conventions makes for easy to navigate code blocks. inline docs gives the model context as it goes instead of having to force it to fish for context. allot of your rules belong in the [AGENTS.md](http://AGENTS.md "http://AGENTS.md") and not necessarily your coding standards. but thats a bit knitpicky. and allot of these thigns are things you as the lead need to be watching for because most models will still do these things.
